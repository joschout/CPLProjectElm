...
--    (Hotkey: ALT + I)
-- Note: which item will be focused on using the hotkeys to focus on the next and previous item
...
-- If a date later than the current date is picked, the item disappears
...
-- In this section, the snoozed items are listed, together with the date until
-- which each item is snoozed.
-- Note: which item will be focused on using the hotkeys to focus on the next and previous item
